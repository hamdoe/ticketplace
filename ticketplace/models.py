...
class Content(db.Model):
    ...
    #TODO: block_image = Column(Text)
    account_bank_code = Column(Text, doc='대표 은행 코드', nullable=False)
    account_name = Column(Text, doc='예금주', nullable=False)
    account_number = Column(Text, doc='계좌 번호', nullable=False)
    ...
    background_image = Column(Text, doc='상품 설명 배경 이미지')
    ...
    index_image = Column(Text, doc='메인 페이지용 이미지')
    ...
    information_file = Column(Text, doc='zip파일')
    ...
    main_image = Column(Text, doc='상품 설명 메인 이미지')
    ...
    resolved_note = Column(Text, doc='정산 내역')
    ...
    thumbnail_image = Column(Text, doc='썸네일 이미지')
